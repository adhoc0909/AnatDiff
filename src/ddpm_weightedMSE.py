...
from utils import CamCAN_2mmDataset_with_tissuemask_2D, read_config, sampling_2D, weighted_mse_loss
import pickle 
...
for epoch in range(n_epochs):
    ...
    for step, batch in progress_bar:
        ...
        with autocast(enabled=True):
            ...
            #weights = (0.1*tissuemask) + 0.9
            weights = (tissuemask*9) + 1 # wm, 1~10
            loss = weighted_mse_loss(noise_pred.float(), noise.float(), weights)
    ...
    if epoch % 10 == 0:
        torch.save(model, '/DATA1/leehw/camcan/models_for_brain_synthesis/ddpm_2D_tissuemask_5_wm_1_10/unet_{}epochs.pt'.format(epoch))
    ...
    if epoch % 10 ==0:
        ...
        nifti.to_filename('/DATA1/leehw/camcan/models_for_brain_synthesis/ddpm_2D_tissuemask_5_wm_1_10/{}epochs_result.nii.gz'.format(epoch))
        
        with open('/DATA1/leehw/camcan/models_for_brain_synthesis/ddpm_2D_tissuemask_5_wm_1_10/unet_history.pkl', 'wb') as f:
...
torch.save(model, '/DATA1/leehw/camcan/models_for_brain_synthesis/ddpm_2D_tissuemask_5_wm_1_10/unet_1000epochs.pt')
